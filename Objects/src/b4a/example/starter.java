...
public static int _num_stars = 0;
public static int _additional = 0;
public static boolean _move = false;
public static boolean _myservice = false;
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Dim SOUND As Boolean";
_sound = false;
 //BA.debugLineNum = 10;BA.debugLine="Dim NUM_STARS As Int";
_num_stars = 0;
 //BA.debugLineNum = 11;BA.debugLine="Dim ADDITIONAL As Int";
_additional = 0;
 //BA.debugLineNum = 12;BA.debugLine="Dim MOVE As Boolean";
_move = false;
